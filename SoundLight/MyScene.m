    ...
    if (self = [super initWithSize:size]) {
        ...
        NSArray * soundPalettes = [NSArray arrayWithObjects:
                                   ...
                                   [NSArray arrayWithObjects:
                                    ...
                                    nil],
                                   [NSArray arrayWithObjects:
                                    [SKAction playSoundFileNamed:@"sounds/Xylo/1-c2.wav" waitForCompletion:false],
                                    [SKAction playSoundFileNamed:@"sounds/Xylo/2-d2.wav" waitForCompletion:false],
                                    [SKAction playSoundFileNamed:@"sounds/Xylo/3-e2.wav" waitForCompletion:false],
                                    [SKAction playSoundFileNamed:@"sounds/Xylo/4-g2.wav" waitForCompletion:false],
                                    [SKAction playSoundFileNamed:@"sounds/Xylo/5-a2.wav" waitForCompletion:false],
                                    [SKAction playSoundFileNamed:@"sounds/Xylo/6-c3.wav" waitForCompletion:false],
